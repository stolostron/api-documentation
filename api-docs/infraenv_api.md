...
|  **agentApproval** | `object` | AgentApproval defines configuration for automatic approval of Agents discovered by this InfraEnv. | N/A |
| └>&nbsp;&nbsp; **autoApprove** | `boolean` | AutoApprove indicates whether Agents discovered using this InfraEnv should be automatically approved by the system. If true, any Agent referencing this InfraEnv may be approved without manual intervention. Use only in trusted environments. | N/A |
