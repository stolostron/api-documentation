...
| └>&nbsp;&nbsp; **minReplicas** | `integer` | No description provided. | `Minimum=0` |
...
|  **imageType** | `string` | ImageType is the AMI (Amazon Machine Image) to use for running the associated NodePool (i.e. Windows or Default/Linux). | N/A |
|  **instanceType** | `string` | InstanceType specifies the AWS instance type, for example `r5.xlarge`. Instance type ref; https://aws.amazon.com/ec2/instance-types/ | N/A |
