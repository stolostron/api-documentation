...
| &nbsp;&nbsp;&nbsp;&nbsp;└>&nbsp;&nbsp; **amiID** | `string` | AMIID is the AMI to use for machines in this pool. When omitted, Hive falls back to its existing behavior of determining an appropriate boot image for the platform. | N/A |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└>&nbsp;&nbsp; **osImage** | `object` | OSImage defines the marketplace image to use for the OS. Mutually exclusive with OSImageID; if both are specified, OSImage is ignored. If neither is specified, the managed cluster will inject a default. | N/A |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└>&nbsp;&nbsp; **offer** | `string` | Offer is the offer of the image. | N/A |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└>&nbsp;&nbsp; **plan** | `string` | Plan is the purchase plan of the image. If omitted, it defaults to "WithPurchasePlan". | N/A |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└>&nbsp;&nbsp; **osImageID** | `string` | OSImageID is the resource path of the managed or gallery image to be used on the VMs. Mutually exclusive with OSImage; if both are specified, OSImage is ignored. If neither is specified, the managed cluster will inject a default. | N/A |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└>&nbsp;&nbsp; **tags** | `array` | Tags defines a set of network tags which will be added to instances in the machineset. Not to be confused with UserTags. | N/A |
