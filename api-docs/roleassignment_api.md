...
|  **condition** | `string` | Condition: The conditions on the role assignment. This limits the resources it can be assigned to. e.g.: @Resource[Microsoft.Storage/storageAccounts/blobServices/containers:ContainerName] StringEqualsIgnoreCase 'foo_storage_container' | N/A |
|  **conditionVersion** | `string` | ConditionVersion: Version of the condition. Currently accepted value is '2.0' | N/A |
|  **delegatedManagedIdentityResourceReference** | `object` | DelegatedManagedIdentityResourceReference: Id of the delegated managed identity resource | N/A |
...
|  **description** | `string` | Description: Description of role assignment | N/A |
...
| └>&nbsp;&nbsp; **namingConvention** | `string` | NamingConvention: The uuid generation technique to use for any role without an explicit AzureName. One of 'stable' or 'random'. | N/A |
...
|  **principalId** | `string` | PrincipalId: The principal ID. | N/A |
|  **principalIdFromConfig** | `object` | PrincipalIdFromConfig: The principal ID. | N/A |
...
|  **principalType** | `string` | PrincipalType: The principal type of the assigned principal ID. | N/A |
|  **roleDefinitionReference** | `object` | RoleDefinitionReference: The role definition ID. | N/A |
| └>&nbsp;&nbsp; **armId** | `string` | ARMID is a string of the form /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}. The /resourcegroups/{resourceGroupName} bit is optional as some resources are scoped at the subscription level ARMID is mutually exclusive with Group, Kind, Namespace and Name. | `Pattern=(?i)(^(/subscriptions/([^/]+)(/resourcegroups/([^/]+))?)?/providers/([^/]+)/([^/]+/[^/]+)(/([^/]+/[^/]+))*$\|^/subscriptions/([^/]+)(/resourcegroups/([^/]+))?$)` |
| └>&nbsp;&nbsp; **group** | `string` | Group is the Kubernetes group of the resource. | N/A |
| └>&nbsp;&nbsp; **kind** | `string` | Kind is the Kubernetes kind of the resource. | N/A |
| └>&nbsp;&nbsp; **name** | `string` | Name is the Kubernetes name of the resource. | N/A |
...
|  **createdBy** | `string` | CreatedBy: Id of the user who created the assignment | N/A |
|  **createdOn** | `string` | CreatedOn: Time it was created | N/A |
|  **delegatedManagedIdentityResourceId** | `string` | DelegatedManagedIdentityResourceId: Id of the delegated managed identity resource | N/A |
|  **description** | `string` | Description: Description of role assignment | N/A |
|  **id** | `string` | Id: The role assignment ID. | N/A |
|  **name** | `string` | Name: The role assignment name. | N/A |
|  **principalId** | `string` | PrincipalId: The principal ID. | N/A |
|  **principalType** | `string` | PrincipalType: The principal type of the assigned principal ID. | N/A |
|  **roleDefinitionId** | `string` | RoleDefinitionId: The role definition ID. | N/A |
|  **scope** | `string` | Scope: The role assignment scope. | N/A |
|  **type** | `string` | Type: The role assignment type. | N/A |
|  **updatedBy** | `string` | UpdatedBy: Id of the user who updated the assignment | N/A |
|  **updatedOn** | `string` | UpdatedOn: Time it was updated | N/A |
